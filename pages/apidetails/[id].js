  ...
  return (
    ...
    <main className='w-full grow flex items-start justify-center relative bg-light-background dark:bg-dark-background'>
      <section className='container w-[calc(100vw-2rem)] md:w-[56rem] my-9 space-y-8 flex flex-col justify-center items-center mb-16'>
        <section>
          <h2 className="border-b-[1px] pb-1 dark:border-gray-700 font-bold text-xl">{apiDetails.name}</h2>
            ...
            <div className='divide-y dark:divide-gray-700 space-y-3'>
              <div className='pt-4'>
                <div className='space-y-1'>
                  <h3 className="text-[#979899] font-bold text-sm">Repositório</h3>
                  <a target="_blank" href={apiDetails.url_repo} className="cursor-pointer" rel="noreferrer">{apiDetails.url_repo}</a>
                </div>  
              </div>
              <div className='pt-4'>
                <div className='space-y-1'>
