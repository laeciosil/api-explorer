export function FeedbackSuccessStep({
  ...
  return (
    <div className="flex flex-col items-center py-10 w-[384px]">
      ...
      <span className="text-xl mt-2 text-light-text dark:text-dark-text">
        Agradecemos o feedback!
      </span>
      <button
        type="button"
        className="py-2 px-6 mt-6 text-dark-text bg-light-secondary rounded-md border-transparent text-sn leading-6 hover:bg-[#737eff] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-light-background dark:focus:ring-offset-dark-primary focus:ring-dark-secondary transition-colors disabled:opacity-50 disabled:hover:bg-dark-secondary"
